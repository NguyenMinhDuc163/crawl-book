...
const jsonFilePath = path.resolve(__dirname, 'gacsach_data', 'all_categories.json');
...
function saveHTML(html, fileName) {
    ...
    try {
        ...
        console.log(`Đã lưu HTML vào file: ${filePath}`);
        return filePath;
    } catch (error) {
        console.error(`Lỗi khi lưu file HTML: ${error.message}`);
        return null;
    }
}
